...
console.log(charCount('helicopter', 'e')); // 2
console.log(charCount('javascript', 'a')); // 2
console.log(charCount('javascript', 'o')); // 0
...
function deleteParams(arr, ...params){
    return arr.filter(val => !params.includes(val));

}
console.log(deleteParams([2,3,5,7,8], 2, 5) )
console.log(deleteParams([1,1,1,2,2,2,3,3], 1,2) )